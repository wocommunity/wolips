...
public class NewWODropDown extends Action implements IMenuCreator, IWorkbenchWindowPulldownDelegate2 {
	...
	private final static String ATT_JAVATYPE = "wotype";//$NON-NLS-1$
