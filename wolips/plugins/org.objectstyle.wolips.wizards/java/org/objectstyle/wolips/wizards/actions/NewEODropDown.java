...
public class NewEODropDown extends Action implements IMenuCreator, IWorkbenchWindowPulldownDelegate2 {
	...
	private final static String ATT_JAVATYPE = "eotype";//$NON-NLS-1$
