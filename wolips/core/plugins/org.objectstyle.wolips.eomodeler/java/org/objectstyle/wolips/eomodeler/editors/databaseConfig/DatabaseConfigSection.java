...
public class DatabaseConfigSection extends AbstractPropertySection {
	...
	protected void addBindings() {
		_bindingContext.bindValue(
				...
				BeanProperties.value(EODatabaseConfig.class, EODatabaseConfig.NAME, String.class).observe(getDatabaseConfig()),
				null, null);
		_bindingContext.bindValue(
				WidgetProperties.text(SWT.Modify).observe(_priorityText),
				BeanProperties.value(EODatabaseConfig.class, EODatabaseConfig.PRIORITY, String.class).observe(getDatabaseConfig()),
				null, null);
		_bindingContext.bindValue(
				WidgetProperties.text(SWT.Modify).observe(_deploymentProfileText),
				BeanProperties.value(EODatabaseConfig.class, EODatabaseConfig.DEPLOYMENT_PROFILE, String.class).observe(getDatabaseConfig()),
				null, null);
