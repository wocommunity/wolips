    ...
    TableViewerSupport support = new TableViewerSupport(_model, parent) {
      ...
      protected ITableLabelProvider createLabelProvider() {
        return new ITableLabelProvider() {
          ...
          public String getColumnText(Object _tagShortcut, int columnIndex) {
            switch (columnIndex) {
            case 0:
              return ((TagShortcut) _tagShortcut).getShortcut();
            case 1:
              return ((TagShortcut) _tagShortcut).getActual();
            case 2:
              return ((TagShortcut) _tagShortcut).getAttributesAsString();
            default:
              return _tagShortcut.toString();
            }
          }
          ...
          public boolean isLabelProperty(Object _tagShortcut, String property) {
            return false;
          }
