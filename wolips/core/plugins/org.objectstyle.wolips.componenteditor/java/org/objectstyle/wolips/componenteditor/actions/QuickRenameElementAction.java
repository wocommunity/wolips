...
import org.objectstyle.wolips.wodclipse.core.refactoring.QuickElementRefactor;
	...
	public void run(IAction action) {
		try {
			...
			if (templateEditor != null && wodEditor != null) {
				...
				QuickElementRefactor.rename(offset, templateEditor.getSourceEditor().getViewer(), wodEditor.getViewer(), cache);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
