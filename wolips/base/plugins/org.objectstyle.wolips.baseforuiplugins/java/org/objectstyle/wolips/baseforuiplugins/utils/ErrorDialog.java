...
public class ErrorDialog extends IconAndMessageDialog {
    ...
    protected Text createErrorDetails(Composite parent) {
        // create the list
    	errorDetails = new Text(parent, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.READ_ONLY);
        // fill the list
        ...
        errorDetails.setLayoutData(data);
        errorDetails.setFont(parent.getFont());
        Menu copyMenu = new Menu(errorDetails);
    ...
    private void toggleDetailsArea() {
        ...
        if (listCreated) {
        	...
        	errorDetails = createErrorDetails((Composite) getContents());
    ...
    private void copyToClipboard() {
        ...
        clipboard = new Clipboard(errorDetails.getDisplay());
    ...
    private void repopulateList() {
        if (errorDetails != null && !errorDetails.isDisposed()) {
	        populateErrorDetails(errorDetails);
        }
    }
}
